.PHONY: help full full-go full-npm docker build build-npm build-go lint lint-npm lint-go test test-npm test-go watch-go clean clean-full copy-config projectl git-change-check
...
projectl:
	@cd ; go install github.com/aaronellington/projectl@latest
